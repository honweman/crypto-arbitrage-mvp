...
class WebMonitorTest(unittest.TestCase):
    def test_page_uses_auto_buy_sell_label(self) -> None:
        self.assertIn(
            '<script src="/static/app.js?v=20260712-coordinate1" defer></script>',
            INDEX_HTML,
        )
        self.assertIn(
            '<script src="/static/i18n.js?v=20260712-coordinate1" defer></script>',
            INDEX_HTML,
        )
        self.assertIn(
    ...
    def test_page_includes_persistent_dark_mode_toggle(self) -> None:
        ...
        self.assertIn(
            '<script src="/static/theme.js?v=20260712-coordinate1"></script>',
            INDEX_HTML,
        )
        self.assertLess(
            INDEX_HTML.index('/static/theme.js?v=20260712-coordinate1'),
            INDEX_HTML.index('/static/styles.css?v=20260712-coordinate1'),
        )
    ...
    def test_order_reconciliation_tracks_market_maker_instances(self) -> None:
        ...
        self.assertIn(
            '<link rel="stylesheet" href="/static/styles.css?v=20260712-coordinate1">',
            INDEX_HTML,
        )
